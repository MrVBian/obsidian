...
- **轻攻击**：轻击一共四段七次伤害，全程真连
- **重攻击**：重击共三段可释放派生技，四次伤害，全程真连，但派生技艺需要点一下
- **武学技**：武学技可释放两段，共五次伤害，第一段为金光释放，追踪舞绡造成四次伤害，第二段敲鼓造成一次击倒伤害
- **特殊技**：三种形态释放时为强韧体，特殊技期间敲鼓时有无敌状态
  - 第一种：点击轻击伤害较高，共四次伤害，以自身为中心扩散，第四段范围较大
  - 第二种：点击重击共三次伤害，以自身为中心扩散，第三次伤害范围较大，且拥有护盾
  - 第三种：点击武学技，三次伤害，可远距离释放，第三次范围较大，且沉默
- **蓄力技**：八次伤害，全程真连结束后可释放派生技
- **易武技**：二段伤害，大僵直，可接奇术
- **防反**：一次伤害

**2. 卸势点与闪避点**

- **武学技**：闪第一段要看弹道，和闪抛春恨同理。第二段看对手敲鼓，卸/闪一次
- **特殊技**：不管对手哪一种，敲鼓卸闪即可
- **蓄力技**：对手人物从左往右转身开始卸。闪和卸的点是一样的
  - 非唐刀：卸六或七下即可
  - 唐刀：卸七或八下
  - 注意：闪需要连闪两下
- **防反**：目到金光闪即可
- **易武技**：目到对手人物从右向左转，卸二下即可，闪避同理
...
- **武学技**：一次伤害大僵直
  - 流风buff时：两次伤害，全程强韧。命中对手时可触发派生技，两次伤害全程强韧
- **特殊技**：三次伤害大僵直，获得流风buff，位移期间为无敌状态
- **蓄力技**：一档为三次伤害，大僵直获得流风buff。二档也是三次伤害，大僵直获得流风buff，伤害及距离高于一档

**2. 卸势点与闪避点**

- **武学技**：对手拍手，卸或闪一下
  - 强化武学技：对手抬手连卸/闪两下
- **特殊技**：对手人物由右向左转身突进，快卸二或三下即可，闪的话也是这个点，但是要注意只能侧前闪，因为这个技能是扇形多段攻击，别的方向闪很容易被抓
- **蓄力技**：对手丢扇子卸二或三下，闪避同理。蓄力技第一下不中没有后续攻击
  - 唐刀需要卸三下
- **派生技**：目到对手弯腰，卸第一下。对手背身划右胳膊收扇子，卸第二下，闪同理

------

#### 常见定音

- **环**：武学技延长定身时间0.6秒。对手为强韧体时，延长定身时间1秒
- **环**：使目标进入受击或受控制状态时，目标额外受到15点真气伤害，并在十秒内受到伤害提升10%
...
flowchart TD
    ...
    C --> E{是否会意？}
    E -->|否| F[擦伤<br/>灰色伤害<br>（固定最小外攻）]
    E -->|是| G[会意<br/>橙色伤害<br>（最大外功 × 1.35）]

    D --> H{是否会心或会意？}
    H -->|会意| G
    H -->|会心| I[会心<br/>黄色伤害<br>（介于小外大外随机值 × 1.5）]
    H -->|否| J[普通攻击<br/>白字伤害<br>（介于小外大外随机值）]

    %% 背景色着色，字体全黑，边框加深以显眼
    style F fill:#C0C0C0, stroke:#666666, color:#000000, stroke-width:2px
    style G fill:#FF9900, stroke:#CC7700, color:#000000, stroke-width:2px
    style I fill:#FFD700, stroke:#B8860B, color:#000000, stroke-width:2px
    style J fill:#FFFFFF, stroke:#999999, color:#000000, stroke-width:2px
```
...
Y + C·P + (1-Y)(1-P) + P·[1-(C+Y)]
= Y + CP + 1 - Y - P + YP + P - PC - PY
= 1
