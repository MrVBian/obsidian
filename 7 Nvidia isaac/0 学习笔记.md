...
[物理边界](https://docs.omniverse.nvidia.com/isaacsim/latest/simulation_fundamentals.html#omni-physics-and-physx-limitations)
...
- [Isaac Lab官方支持论坛](https://github.com/isaac-sim/IsaacLab/discussions)
...
API文档：
	...
	- [Omniverse Kit](https://docs.omniverse.nvidia.com/kit/docs/kit-manual/104.0/)
...
blender转usd：
- https://www.aigei.com/3d/model/
- https://www.3dwhere.com/conv/Blender-to-USD
...
- **增加刚度值**：提高执行器的刚度参数可以增强位置保持能力
- **阻尼调整**：适当增加阻尼可以减少振荡，但过大的阻尼会导致响应迟缓
...
[单位](https://docs.omniverse.nvidia.com/isaacsim/latest/reference_conventions.html)
...
[Motion Blur（运动模糊）](https://docs.omniverse.nvidia.com/isaacsim/latest/replicator_tutorials/tutorial_replicator_object_based_sdg.html#motion-blur)
[Performance Optimization（性能优化）](https://docs.omniverse.nvidia.com/isaacsim/latest/replicator_tutorials/tutorial_replicator_object_based_sdg.html#performance-optimization)


[Enable Omni.Replicator.Agent](https://docs.omniverse.nvidia.com/isaacsim/latest/replicator_tutorials/tutorial_replicator_omni_replicator_agent.html#enable-omni-replicator-agent)
[Object Detection Synthetic Data Generation](https://docs.omniverse.nvidia.com/isaacsim/latest/replicator_tutorials/tutorial_replicator_object.html#expected-output)：omni.replicator.object插件

## 12 Isaac Sim App Selector应用程序选择器

| https://docs.omniverse.nvidia.com/isaacsim/latest/reference_material/reference_user_interface.html#isaac-sim-app-selector                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Starts the selected app with the added commandline flags.<br><br>Some useful commands below:<br><br>`-v` for verbose logging in the terminal<br><br>`--reset-user` reset user config<br><br>`--/app/window/width=1920` set the application window width<br><br>`--/app/window/height=1080` set the application window height<br><br>`--/app/renderer/resolution/width=1920` set the renderer resolution width<br><br>`--/app/renderer/resolution/height=1080` set the renderer resolution height<br><br>`--/exts/omni.services.transport.server.http/port=8211` set the HTTP server port<br><br>`--/renderer/activeGpu=0` to set the GPU used by Isaac Sim to the specified number<br><br>Note: Run Isaac Sim with the `--help` flag to see additional commandline flags. |
...
| ------ | ---------------------------- | ----------- |
| 物理引擎   | PhysX5                       | PhysX3      |
| 渲染引擎   | Omniverse RTX Renderer（实时光追） | URP or HDRP |
| 机器学习框架 | Isaac Lab（RL和IL）             | 第三方         |
...
https://docs.omniverse.nvidia.com/isaacsim/latest/features/sensors_simulation/isaac_sim_sensors_physics_based_contact.html#contact-sensor
...
https://forums.developer.nvidia.com/t/publishing-ros2-custom-message-from-omniverse/212959/5

https://docs.omniverse.nvidia.com/extensions/latest/ext_particles/tutorial_create-point-instancer.html#collider-node-tweaks


https://blog.csdn.net/m0_56661101/article/details/133798646

## 13 direct-gpu-api
https://nvidia-omniverse.github.io/PhysX/physx/5.4.1/docs/GPURigidBodies.html#direct-gpu-api


| Key              | Des                    |
| ---------------- | ---------------------- |
| root             | dummy joint xyz和rpy    |
| optimized_joints | fingers joints         |
| object_poses     | object的6dpose xyzw和xyz |
